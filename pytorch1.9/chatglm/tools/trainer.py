    ...
    def _load_rng_state(self, checkpoint):
        ...
        if torch.mlu.is_available():
            if self.args.local_rank != -1:
                torch_mlu.core.random.set_rng_state(checkpoint_rng_state["mlu"])
            else:
                try:
                    torch_mlu.core.random.set_rng_state_all(checkpoint_rng_state["mlu"])
    ...
    def _save_checkpoint(self, model, trial, metrics=None):
        ...
        if torch.mlu.is_available():
            if self.args.local_rank == -1:
                ...
                rng_states["mlu"] = torch_mlu.core.random.get_rng_state_all()
            else:
                rng_states["mlu"] = torch_mlu.core.random.get_rng_state()

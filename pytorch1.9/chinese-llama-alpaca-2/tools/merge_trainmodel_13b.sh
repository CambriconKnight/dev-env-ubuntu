...
# Description:  合并lora权重 得到最终权重 用于推理。final_model == pretrain_model + train_output_finetuning_13b(sample_lora_13b/adapter_model.bin)
...
final_model=${chinese_alpaca_2_model_train_done_13b}

# 合并lora权重 得到最终权重 用于推理
echo "Cambricon Running STEP3_MERGE_TRAIN_MODEL......"
checkpoints=`ls -l ${train_output_finetuning_13b} | awk '{print $9}' |  grep "checkpoint"`
mv ${train_output_finetuning_13b}/${checkpoints}/pytorch_model.bin sample_lora_13b/adapter_model.bin

...
#pytorch镜像的版本号，如【pytorch-v1.13.0-torch1.6-ubuntu18.04-py37.tar.gz】则取作【1.13.0】。
VER="1.13.0"
Owner="kang"
#################### docker ####################
#Work
...
OSVer="18.04"
#Operating system，如【pytorch-v1.13.0-torch1.6-ubuntu18.04-py37.tar.gz】则取作【ubuntu18.04-py37】。
OS="ubuntu$OSVer-py37"
#FrameVersion，如【pytorch-v1.13.0-torch1.6-ubuntu18.04-py37.tar.gz】则取作【v1.13.0-torch1.6】。
FrameVer="v$VER-torch1.6"
